  ...
  const Circles = () =>
    radii.map(r => (
      <circle
        ...
        {...{ r }}
        strokeWidth={2}
        stroke={oklch(0.1, 0.12, 60).hex()}
        fill={oklch(0.1, 0.12, 60, 0.1).hex()}
      />
    ));
  const Rays = () =>
    rayPaths.map((d, i) => (
  ...
  return (
    ...
    >
      ...
      <D
        ...
        stroke={oklch(0, 0.12, 60, 0.75).hex()}
      />
      <D
        strokeWidth={radii[2] * phi ** 3}
        stroke={oklch(0.4, 0.12, 60, 0.9).hex()}
      />
      <D strokeWidth={2} />
      <R
        strokeWidth={radii[2] * phi ** 2}
        stroke={oklch(0.5, 0.12, 60, 0.75).hex()}
      />
      <R
        strokeWidth={radii[2] * phi ** 3}
        stroke={oklch(0.9, 0.12, 60, 0.9).hex()}
      />
      <R
        strokeWidth={2}
        stroke={oklch(0.1, 0.12, 60).hex()}
